...
//   // Update this useEffect in PaymentSection.tsx:
//   useEffect(() => {
//     console.log("🔄 useEffect triggered - grandTotal:", grandTotal, "selectedMethod:", selectedMethod);
//     // Only auto-fill for cash/upi, not for credit
//     if (grandTotal > 0 && selectedMethod !== "credit") {
...
//   // In PaymentSection.tsx, update the handleMethodSelect function:
...
//     if (method === "credit") {
//       console.log("🟢 Setting credit amount to:", grandTotal);
//       setAmountGiven(grandTotal);
//       onPaymentChange(0, "amount", grandTotal);
