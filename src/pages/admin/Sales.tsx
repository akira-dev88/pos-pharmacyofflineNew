    ...
    <div className="space-y-6 font-inter">
      ...
      <div className="flex justify-between items-center font-inter">
        <div className="space-y-1 text-start">
          ...
          <p className="text-gray-300 text-sm mt-1">{t('sales.subtitle')}</p>
        </div>
        <button
          onClick={loadSales}
          disabled={loading}
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-start">
        <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-4 text-white">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-blue-100 text-sm">{t('sales.totalSales')}</p>
        ...
        <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-4 text-white">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-green-100 text-sm">{t('sales.averageSale')}</p>
        ...
        <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl p-4 text-white">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-purple-100 text-sm">{t('sales.todaySales')}</p>
        ...
        <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl p-4 text-white">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-orange-100 text-sm">{t('sales.totalTransactions')}</p>
        ...
        <div className="overflow-x-auto text-start">
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                <th className="text-left p-4 text-sm font-semibold text-gray-600">{t('sales.tableInvoice')}</th>
                <th className="text-left p-4 text-sm font-semibold text-gray-600">{t('sales.tableCustomer')}</th>
                <th className="text-right p-4 text-sm font-semibold text-gray-600">{t('sales.tableAmount')}</th>
                <th className="text-left p-4 text-sm font-semibold text-gray-600">{t('sales.tableDate')}</th>
                <th className="text-center p-4 text-sm font-semibold text-gray-600">{t('sales.tableStatus')}</th>
                <th className="text-center p-4 text-sm font-semibold text-gray-600">{t('sales.tableAction')}</th>
              </tr>
            </thead>
            <tbody>
              {loading ? (
                <tr>
                  <td colSpan={6} className="text-center p-8">
                    ...
                    <p className="mt-2 text-gray-500">{t('sales.loadingSales')}</p>
                  </td>
                </tr>
